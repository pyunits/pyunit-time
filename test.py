...
def time():
    ...
    assert Time('2020-4-22 10:10:10').parse('我后天去北京') == [
        {'key': '后天', 'keyDate': '2020-04-24 00:00:00', 'baseDate': '2020-04-22 10:10:10'}]

    assert Time('2020-9-20 00:00:00').parse('00年出生的孩子爱看的电视剧') == [
        {'key': '00年', 'keyDate': '2000-09-20 00:00:00', 'baseDate': '2020-09-20 00:00:00'}]

    assert Time('2020-9-20 00:00:00').parse('这个月的最后一天的前一天') == [
        {'key': '这个月最后1天前1天', 'keyDate': '2020-09-29 00:00:00', 'baseDate': '2020-09-20 00:00:00'}]

    assert Time('2020-9-20 00:00:00').parse('这个月的第一天') == [
        {'key': '这个月第1天', 'keyDate': '2020-09-01 00:00:00', 'baseDate': '2020-09-20 00:00:00'}]

    assert Time('2020-9-20 00:00:00').parse('这个月的最后1个星期5') == [
        {'key': '这个月最后1个星期5', 'keyDate': '2020-09-25 00:00:00', 'baseDate': '2020-09-20 00:00:00'}]

    assert Time('2020-9-20 00:00:00').parse('这个月的第1个星期1') == [
        {'key': '这个月第1个星期1', 'keyDate': '2020-09-07 00:00:00', 'baseDate': '2020-09-20 00:00:00'}]
