...
def company():
    assert Time('2021-3-4 20:00:00').parse('请陈小利、苏杨星期三早上10点在省公司参加安全培训') == [
        {'key': '星期3早上10点', 'keyDate': '2021-03-10 10:00:00', 'baseDate': '2021-03-04 20:00:00'}]
    assert Time('2024-3-4 20:00:00').parse('12年前') == [
        {'key': '12年前', 'keyDate': '2012-03-04 20:00:00', 'baseDate': '2024-03-04 20:00:00'}]
