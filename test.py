...
def time():
    ...
    print(Time('2020-4-22 00:00:00').parse('2020-1-2 10:20:10'))
    # [{'key': '2020-1-2 10:20:10', 'keyDate': '2020-01-02 10:20:10', 'baseDate': '2020-04-22 00:00:00'}]

    print(Time('2020-4-22 00:00:00').parse('明晚九点，明天晚上九点'))
    ...
    print(Time('2020-4-22 00:00:00').parse('昨晚九点，昨天晚上九点'))
    # [{'key': '明晚9点', 'keyDate': '2020-04-21 21:00:00', 'baseDate': '2020-04-22 00:00:00'},
    # {'key': '明天晚上9点', 'keyDate': '2020-04-21 21:00:00', 'baseDate': '2020-04-22 00:00:00'}]

    print(Time('2020-4-22 10:10:10').parse('前晚九点这个时候，前天晚上九点'))
    # [{'key': '明晚9点', 'keyDate': '2020-04-20 21:00:00', 'baseDate': '2020-04-22 00:00:00'},
    # {'key': '明天晚上9点', 'keyDate': '2020-04-20 21:00:00', 'baseDate': '2020-04-22 00:00:00'}]

    print(Time('2020-4-22 10:10:10').parse('我后天去北京'))
